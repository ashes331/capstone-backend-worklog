...
| 경로 | 내용 |
|---|---|
| [`버그 수정 작업 (2026-07-20~26)/WORKLOG.md`](<./버그 수정 작업 (2026-07-20~26)/WORKLOG.md>) | 발견부터 수정, 검증, 커밋/push까지 시간순 작업 기록 |
| [`버그 수정 작업 (2026-07-20~26)/fixed-code/`](<./버그 수정 작업 (2026-07-20~26)/fixed-code>) | 이번에 수정한 backend 코드 16개 파일 |
| [`보고서 정리 작업 (2026-07-20~26)/report.html`](<./보고서 정리 작업 (2026-07-20~26)/report.html>) | 모듈별 테스트 결과, 지시서 대조 체크리스트, 핵심 수정 코드를 정리한 웹 문서 |
